...
\lstdefinelanguage{Rust}{
  keywords={fn, let, mut, pub, use, struct, impl, enum, match, if, else, for, while, loop, return, self, Self, true, false, const, static, type, trait, where, mod, extern, crate, super, ref, move, async, await, dyn, unsafe, in},
  sensitive=true,
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
  string=[b]",
